declare global {
  const JASUKE_TOPPINGS: typeof import('../../utils/store').JASUKE_TOPPINGS
  const MENU_ITEMS: typeof import('../../utils/store').MENU_ITEMS
  const addTransaction: typeof import('../../utils/store').addTransaction
  ...
  const deleteTransaction: typeof import('../../utils/store').deleteTransaction
  ...
  const getTransactions: typeof import('../../utils/store').getTransactions
...
export { MENU_ITEMS, JASUKE_TOPPINGS, getTransactions, addTransaction, deleteTransaction } from 'C:/OneDrive/Documents/Jasuke/backend/utils/store';