...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestURL, getRequestHeader, getResponseHeader, getRequestHeaders, setResponseHeaders, setResponseStatus, send, removeResponseHeader, appendResponseHeader, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getQuery as getQuery$1 } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/h3/dist/index.mjs';
import destr from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/node-mock-http/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/ohash/dist/index.mjs';
import { klona } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/scule/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/source-map/source-map.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/OneDrive/Documents/Jasuke/backend/node_modules/pathe/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/OneDrive/Documents/Jasuke/backend/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/OneDrive/Documents/Jasuke/backend"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/OneDrive/Documents/Jasuke/backend"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/OneDrive/Documents/Jasuke/backend/.nitro"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/OneDrive/Documents/Jasuke/backend/.nitro/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/OneDrive/Documents/Jasuke/backend/.data/kv"}));
...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"c292-JfA9yCQV78ukijRFTS4Q/HjgWKo\"",
    "mtime": "2026-06-22T21:37:03.600Z",
    "size": 49810,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"2b91c-a4bRftlfUVyYgPQGFbbz+H2k6mQ\"",
    "mtime": "2026-06-22T21:37:03.601Z",
    "size": 178460,
    "path": "index.mjs.map"
  }
};
...
const _VVOCoE = eventHandler((event) => {
...
const _lazy_URFuHq = () => Promise.resolve().then(function () { return menu_get$1; });
const _lazy_PoxulX = () => Promise.resolve().then(function () { return toppings_get$1; });
const _lazy_jVf16e = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_PtFOy4 = () => Promise.resolve().then(function () { return index_get$1; });
const _lazy_6AdDca = () => Promise.resolve().then(function () { return index_post$1; });

const handlers = [
  { route: '', handler: _VVOCoE, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _YyCE_c, lazy: false, middleware: true, method: undefined },
  { route: '/api/menu', handler: _lazy_URFuHq, lazy: true, middleware: false, method: "get" },
  { route: '/api/toppings', handler: _lazy_PoxulX, lazy: true, middleware: false, method: "get" },
  { route: '/api/transactions/:id', handler: _lazy_jVf16e, lazy: true, middleware: false, method: "delete" },
  { route: '/api/transactions', handler: _lazy_PtFOy4, lazy: true, middleware: false, method: "get" },
  { route: '/api/transactions', handler: _lazy_6AdDca, lazy: true, middleware: false, method: "post" },
  { route: '/api/**', handler: _YyCE_c, lazy: false, middleware: true, method: undefined }
];
...
const toppings_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: toppings_get
});
